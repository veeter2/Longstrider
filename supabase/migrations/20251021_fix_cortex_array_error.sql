-- Migration: Fix get_cortex function array handling error
-- Date: 2025-10-21
-- Issue: Malformed array literal error when v column is text/jsonb

-- Drop the existing function if it exists
DROP FUNCTION IF EXISTS public.get_cortex(text, text);

-- Create the fixed version that properly handles array conversion
